...
function getSeatPos(index: number, total: number) {
  if (total === 10) {
    ...
    const maxPositions = [
      { x: 190, y: 125 },  // Громадянин 1 (Зверху-ліворуч)
      { x: 500, y: 125 },  // Громадянин 2 (Зверху-центр)
      { x: 810, y: 125 },  // Громадянин 3 (Зверху-праворуч)
      { x: 850, y: 375 },  // Громадянин 4 (Справа-вгорі)
      { x: 850, y: 625 },  // Громадянин 5 (Справа-внизу)
      { x: 810, y: 875 },  // Громадянин 6 (Знизу-праворуч)
      { x: 500, y: 875 },  // Громадянин 7 (Знизу-центр)
      { x: 190, y: 875 },  // Громадянин 8 (Знизу-ліворуч)
      { x: 150, y: 625 },  // Громадянин 9 (Зліва-внизу)
      { x: 150, y: 375 }   // Громадянин 10 (Зліва-вгорі)
    ]
